...
export const projects: Project[] = [
  ...
  },
  {
    ...
    skills: {
      en: 'Information architecture, filtering/comparison UX, data visualization, and frontend state design.',
      zh: '信息架构、筛选与对比体验、数据可视化，以及前端状态设计。',
    },
    progress: {
      en: 'An interactive frontend prototype is complete for filtering an eight-device sample dataset and visually comparing up to four handhelds; data provenance, version consistency, and release preparation are now in progress.',
      zh: '已完成基于 8 台示例设备的掌机筛选与最多 4 台可视化对比前端原型，当前正在整理数据来源、版本一致性和发布准备。',
    },
    nextStep: {
      en: 'Next, I will unify the version labels and device data source, document the scoring basis and update date, and complete export wiring, browser smoke tests, and a hosted demo.',
      zh: '下一步将统一版本号和设备数据源，补充评分依据与更新时间，并接通导出功能、浏览器烟雾测试和公开演示部署。',
    },
    status: 'in-development',
